...
const { app, ctx } = await buildApp({ databaseUrl: config.databaseUrl, pgliteDir: config.pgliteDir, redisUrl: config.redisUrl, storageDir: config.storageDir, webDir: config.webDir, logger: true });
